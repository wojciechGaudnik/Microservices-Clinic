package com.clinics.doctors.data.bootstrap;

import com.clinics.doctors.data.model.*;
import com.clinics.doctors.data.model.Calendar;
import com.clinics.doctors.data.repositorie.*;
...
public class BootStrapDoctors implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		com.clinics.doctors.data.model.Calendar calendarPediatric = com.clinics.doctors.data.model.Calendar
				.builder()
		...
		com.clinics.doctors.data.model.Calendar calendarGP = com.clinics.doctors.data.model.Calendar
				.builder()
		...
		com.clinics.doctors.data.model.Calendar calendarNeurologist = com.clinics.doctors.data.model.Calendar
				.builder()
				.calendarUUID(UUID.fromString("63c7bedf-b6a5-4d83-a8a6-aa2e57f21dcd"))
				.name("Neurologist Calendar")
				.build();

		com.clinics.doctors.data.model.Calendar calendarCardiologist = com.clinics.doctors.data.model.Calendar
				.builder()
		...
		com.clinics.doctors.data.model.Calendar calendarUrologist = com.clinics.doctors.data.model.Calendar
				.builder()
				.calendarUUID(UUID.fromString("39efd271-8448-40d8-932b-182ee14d4a2b"))
				.name("Urologist Calendar")
				.build();

		com.clinics.doctors.data.model.Calendar calendarGynecologist = Calendar
				.builder()
